...
<body class="no-skin">
<%
    ArrayList<Catalog> list = (ArrayList<Catalog>) request.getAttribute("list");
%>
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-480 color-blue"><%= p.getName()%>
                                            </td>
                                            <td class="hidden-480 color-blue"><%= p.getParentId()%>
                                            </td>
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="green"
                                                       href="#newCataLogModal" data-toggle="modal"
                                                       data-catalog-id="<%=p.getId()%>"
                                                    >
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary"
                       href="<%= Util.fullPathAdmin("productCatalogs/delete?&id=")%>">ĐỒNG Ý</a>
                </div>
            </div>
        </div>
    </div>

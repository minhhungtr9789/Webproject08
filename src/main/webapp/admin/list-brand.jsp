                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="hidden-480 color-blue"><%= p.getBrandName()%>
                                            <td class="hidden-480 color-blue">
                                                <%
                                                    String url = "";
                                                    if (p.getBrandImg() != null && !"".equals(p.getBrandImg()))
                                                        url = p.getBrandImg();
                                                %>
                                                <img src="<%= url%>" style="max-height: 35px;" alt="">
                                            </td>
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    <a class="green"
                                                       href="<%= Util.fullPathAdmin("product/edit?id="+p.getBrandId())%>">
                                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                    </a>

                                                    <a class="red" href="#exampleModal" data-toggle="modal"
                                                       data-product-id="<%=p.getBrandId()%>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary"
                       href="<%= Util.fullPathAdmin("brand/delete?&id=")%>">ĐỒNG Ý</a>
                </div>
            </div>
        </div>
    </div>

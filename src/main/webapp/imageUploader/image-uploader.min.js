...
!function (e) {
    e.fn.imageUploader = function (t) {
        let n, i = {
            ...
            label: "Kéo & Thả ảnh hoặc click tại đây",
        ...
        let o = function () {
            ...
            e("<i>", {class: "far fa-trash-alt"}).appendTo(r);
            if (o) {
            ...
            return !(a.settings.extensions.indexOf(e.name.replace(new RegExp("^.*\\."), ".")) < 0) || (alert(`File "${e.name}" không phải file ảnh, xin chọn ảnh có đuôi: "${a.settings.extensions.join('", "')}"`), !1)
        }, c = function (e) {
            ...
            return !(e.size > a.settings.maxSize) || (alert(`File "${e.name}" vượt quá kích thước tối đa ${a.settings.maxSize / 1024 / 1024}Mb`), !1)
        }, m = function (e, t) {

            return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles) || (alert(`File "${t.name}" không thể thêm, bởi vì đã đạt số lượng ${a.settings.maxFiles}`), !1)
        }, u = function (t, n) {
